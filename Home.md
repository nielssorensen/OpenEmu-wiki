...
An experimental release incorporating several additional cores not present in the stable version (including Nintendo 64, PlayStation, and arcade systems) is also available. Both releases can also be downloaded from the [GitHub Releases page](https://github.com/OpenEmu/OpenEmu/releases).
