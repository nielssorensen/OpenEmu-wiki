...
- transition to the Homebrew collection has a longer delay than the rest of the collections. The delay lasts the length of the crossfade duration, and setting the duration to 0 eliminates the delay.
