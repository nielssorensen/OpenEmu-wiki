...
- OpenEmu's preferences tab icons are 36x36, but the Regular size mode of NSToolbar uses HIG-specified size of 32x32, causing noticeable scaling. Before/after conversion to NSTabViewController: http://i.imgur.com/FWSyIJQ.png
